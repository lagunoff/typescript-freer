...
export type T1<A = any> = Type<URIS, A>;
export type T2<L = any, A = any> = Type2<URIS2, L, A>;
export type T3<U = any, L = any, A = any> = Type3<URIS2, U, L, A>;
export type T4<X = any, U = any, L = any, A = any> = Type4<URIS2, X, U, L, A>;
